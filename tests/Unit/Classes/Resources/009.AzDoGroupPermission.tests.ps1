...
Describe 'AzDoGroupPermission Tests' -Tag "Unit", "Resources" {
    ...
    Context 'Get Method' {
        ...
        BeforeAll {
            Mock -CommandName Get-AzDoGroupPermission -ModuleName AzureDevOpsDscNative {
        ...
        It 'Should return current state properties' {
            ...
            Assert-MockCalled Get-AzDoGroupPermission -Exactly 1 -ModuleName AzureDevOpsDscNative
    ...
    Context 'Test Method' {
        ...
        It 'Should return $false when calling the test method - when the status is null' {
            ...
            Mock -CommandName New-InvalidOperationException -ModuleName AzureDevOpsDscNative {
            ...
            $groupPermission.Test() | Should -Be $false
            Assert-MockCalled New-InvalidOperationException -Times 1 -ModuleName AzureDevOpsDscNative
