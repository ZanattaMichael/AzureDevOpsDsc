...
Describe 'List-DevOpsArtifactFeeds' -Tags "Unit", "API" {
    ...
    BeforeAll {
        if ($null -eq $currentFile) {
            $currentFile = Join-Path -Path $PSScriptRoot -ChildPath 'List-DevOpsArtifactFeeds.tests.ps1'
        }
    ...
    It 'Returns data when API returns results' {
        $result = List-DevOpsArtifactFeeds -ApiUri 'https://feeds.dev.azure.com/myorg'
    ...
    It 'Calls Invoke-AzDevOpsApiRestMethod with GET method' {
        List-DevOpsArtifactFeeds -ApiUri 'https://feeds.dev.azure.com/myorg'
    ...
    It 'Throws when the API call fails' {
        ...
        { List-DevOpsArtifactFeeds -ApiUri 'https://feeds.dev.azure.com/myorg' } | Should -Throw
    }
