...
Describe 'List-DevOpsVariableGroups' -Tag "Unit", "VariableGroup", "API" {
    ...
    BeforeAll {
        if ($null -eq $currentFile) {
            $currentFile = Join-Path -Path $PSScriptRoot -ChildPath 'List-DevOpsVariableGroups.tests.ps1'
        }
    ...
    It 'Returns data when API returns results' {
        $result = List-DevOpsVariableGroups -ApiUri 'https://dev.azure.com/myorg' -ProjectName 'TestProject'
    ...
    It 'Calls Invoke-AzDevOpsApiRestMethod with GET method' {
        List-DevOpsVariableGroups -ApiUri 'https://dev.azure.com/myorg' -ProjectName 'TestProject'
    ...
    It 'Throws when the API call fails' {
        ...
        { List-DevOpsVariableGroups -ApiUri 'https://dev.azure.com/myorg' -ProjectName 'TestProject' } | Should -Throw
    }
