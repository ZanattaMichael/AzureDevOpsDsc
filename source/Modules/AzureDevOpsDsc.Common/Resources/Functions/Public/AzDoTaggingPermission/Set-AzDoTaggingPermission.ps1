Function Set-AzDoTaggingPermission
{
    [CmdletBinding()]
    param (
    ...
    Write-Verbose "[Set-AzDoTaggingPermission] Started."
    ...
    if (-not $Project)
    {
        Write-Verbose "[Set-AzDoTaggingPermission] Project '$ProjectName' not in cache — falling back to live API lookup."
    ...
    {
        throw "[Set-AzDoTaggingPermission] Security namespace or project not found. Cannot converge on '$ProjectName'."
    }
