Function New-AzDoAnalyticsPermission
{
    [CmdletBinding()]
    param (
    ...
    Write-Verbose "[New-AzDoAnalyticsPermission] Started."
    ...
    if (-not $Project)
    {
        Write-Verbose "[New-AzDoAnalyticsPermission] Project '$ProjectName' not in cache — falling back to live API lookup."
    ...
    {
        throw "[New-AzDoAnalyticsPermission] Security namespace or project not found. Cannot converge on '$ProjectName'."
    }
