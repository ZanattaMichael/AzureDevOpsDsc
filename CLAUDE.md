...
| `128.AzDoOrgPipelineSettings.ps1` | `AzDoOrgPipelineSettings` | Organization-scoped pipeline settings; `_apis/build/generalsettings` with no project segment; shares compare/patch helpers with `AzDoPipelineSettings` (100) |
